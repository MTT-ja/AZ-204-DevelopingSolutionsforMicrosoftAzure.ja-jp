...
1. 次のコマンドを実行して、現在のディレクトリを **C:\\Allfiles\\Labs\\02\\Starter\\func** の空のディレクトリに変更します。

    ```powershell
    cd F:\Allfiles\Labs\02\Starter\func
    ```

    > **注**: Windows エクスプローラーで、**C:\\Labs\\02\\Starter\\func\\.gitignore** ファイルから**読み取り専用**属性を削除してください。
...
1. 開く **[エクスプローラー]** ウィンドウで、**C:\\Allfiles\\Labs\\02\\Starter\\func** を参照し、 **[フォルダーの選択]** を選択します。
...
1. タスク バーで、**[ターミナル]** アイコンを選択します。
1. 次のコマンドを実行して、現在のディレクトリを **C:\\Allfiles\\Labs\\02\\Starter\\func** ディレクトリに変更します。
...
1. **[BLOB のアップロード]** ウィンドウで、次のアクションを実行し、 **[アップロード]** を選択します。
    ...
    | **[エクスプローラー]** ウィンドウ  | **C:\\Allfiles\\Labs\\02\\Starter** を参照し、**settings.json** ファイルを選択してから **[開く]** を選択します |
